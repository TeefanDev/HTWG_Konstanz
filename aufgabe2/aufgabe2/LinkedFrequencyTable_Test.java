 ...
 * @since 04.03.2021
 */
public class LinkedFrequencyTable_Test {
	...
	private static void test1() {
		// Test von add:
		FrequencyTable tab1 = new LinkedFrequencyTable();
		tab1.add("das");
		tab1.add("ist");
		tab1.add("ein",2);
		tab1.add("Test");
		...
		// Test von addAll:
		FrequencyTable tab2 = new LinkedFrequencyTable();
		tab2.add("das",2);
		tab2.add("ist",4);
		tab2.add("kurzer");
		tab2.add("Text");
	...
	private static void test2() throws FileNotFoundException, IOException {
		FrequencyTable tab = new LinkedFrequencyTable();
